...
export async function GET(request: NextRequest) {
  try {
    ...
    if (tenantError) {
      console.error('Failed to fetch tenant referral code:', tenantError);
    ...
    if (clicksError) {
      console.error('Failed to fetch referral clicks:', clicksError);
    }
    ...
    console.error('Error in referrals GET:', err);
