...
const CATEGORIES: FeatureCategory[] = [
  ...
  },
  {
    ...
    color: '#f5c842',
    tags: [
      { id: 'products', label: '商品管理', icon: '📦', description: '後台管理商品、規格變體（顏色/尺寸）、庫存預警、CSV 批次匯入、商品 SEO 欄位。', demoUrl: '/p/demo/products', demoLabel: 'Demo: 商品管理' },
      ...
      { id: 'orders', label: '訂單管理', icon: '📋', description: '訂單狀態追蹤、退款一鍵操作、客戶溝通記錄、CSV 匯出。', demoUrl: '/p/demo/orders', demoLabel: 'Demo: 訂單管理' },
      { id: 'cart', label: '購物車+結帳', icon: '🛒', description: '訪客/會員結帳、優惠券即時套用、積分折抵、記住付款方式加速回購。', demoUrl: '/p/demo/checkout', demoLabel: 'Demo: 結帳流程' },
      { id: 'product-reviews', label: '商品評價', icon: '⭐', description: '購買後 7 天自動發評價邀請，星評+文字評論顯示於商品頁，留評回饋積分。', demoUrl: '/p/demo/reviews', demoLabel: 'Demo: 商品評價' },
    ],
  },
  {
    title: '👤 會員體系',
    ...
    tags: [
      ...
      { id: 'credits', label: '堂數/點數管理', icon: '🎫', description: '堂數制/點數制/儲值金三種模式，自動追蹤消耗，到期提醒。', demoUrl: `/m/${DEMO_TOKENS.anna}`, demoLabel: 'Demo: 會員查餘額' },
      { id: 'vip', label: 'VIP 分級', icon: '👑', description: '一般/銀/金/鑽石四級，依累計消費自動升降級，專屬折扣+積分倍率。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台會員管理' },
      { id: 'points', label: '積分+兌換', icon: '⭐', description: '消費回饋積分，可折抵購物，VIP 倍率不同，推薦好友雙方各獲積分。', demoUrl: `/m/${DEMO_TOKENS.anna}`, demoLabel: 'Demo: 會員積分' },
      { id: 'coupons', label: '優惠券+發券', icon: '🎁', description: '固定金額/百分比/免運費，按 VIP 等級批次發券，使用限制+有效期。', demoUrl: '/p/demo/checkout', demoLabel: 'Demo: 結帳優惠券' },
      { id: 'referral', label: '推薦+生日禮', icon: '🎂', description: '推薦連結自動追蹤，被推薦人首購後雙方得獎。生日前 3 天自動發生日券。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台會員管理' },
      { id: 'member-center', label: '會員中心', icon: '👤', description: '查看訂單記錄、積分餘額、可用優惠券、數位商品下載連結。', demoUrl: `/m/${DEMO_TOKENS.anna}`, demoLabel: 'Demo: 會員中心' },
    ],
  },
  {
    title: '🤖 AI 智能會員系統',
    color: '#14b8a6',
    tags: [
      { id: 'booking', label: '線上預約', icon: '📅', description: '客人 SMS 連結直接預約，選服務→選日期→選技師→確認，不用你回訊息。', demoUrl: `/m/${DEMO_TOKENS.anna}/book`, demoLabel: 'Demo: 客人預約流程' },
      { id: 'checkin', label: '核銷扣堂', icon: '✅', description: '客人到場說 6 位數字，你輸入就自動扣堂，10 秒完成。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台核銷' },
      { id: 'review-guide', label: '評論引導', icon: '💬', description: '服務後自動問卷，好評導 Google Review，差評留內部改進。留評送積分。', demoUrl: `/m/${DEMO_TOKENS.mary}/feedback/demo`, demoLabel: 'Demo: 問卷評論' },
      { id: 'dormant', label: '沉睡喚醒', icon: '💤', description: '30 天沒來自動 SMS 提醒方案餘額，60 天送積分邀回。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台沉睡清單' },
      { id: 'sms-remind', label: 'SMS 提醒', icon: '📱', description: '預約前 24hr 自動提醒+注意事項。CASL 合規，含退訂機制。', demoUrl: `/m/${DEMO_TOKENS.anna}`, demoLabel: 'Demo: 會員收到通知' },
      { id: 'data', label: '數據分析', icon: '📊', description: '打開手機 2 分鐘看完：營收、到課率、誰快到期、誰沒來。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台全覽' },
    ],
  },
  {
    title: '📧 行銷自動化',
    color: '#22c55e',
    tags: [
      { id: 'email-auto', label: 'Email 自動化', icon: '📧', description: '歡迎信、訂單確認、VIP 升級恭喜、積分到期提醒、AI 流失挽回信。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台自動化' },
      { id: 'cart-abandon', label: '購物車挽回', icon: '🛒', description: '加入購物車 1h 未結帳，自動發提醒 Email，附一次性折扣碼。', demoUrl: '/p/demo/dashboard', demoLabel: 'Demo: 後台統計' },
      { id: 'sms-push', label: 'SMS 推播', icon: '📱', description: '訂單狀態更新、限時活動通知，搭配 Email 雙渠道觸達。CASL 合規。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台 SMS' },
      { id: 'dashboard', label: '商家後台', icon: '📊', description: '今日營收/訂單數/新會員、熱銷 Top 5、AI 流失預警名單、CSV 匯出。', demoUrl: '/p/demo/admin', demoLabel: 'Demo: 後台全覽' },
      { id: 'blog', label: 'Blog / SEO', icon: '📝', description: '文章後台管理，SEO Meta + 結構化資料，文章分類與標籤管理。', demoUrl: '/blog', demoLabel: 'Demo: Blog' },
    ],
  },
];
